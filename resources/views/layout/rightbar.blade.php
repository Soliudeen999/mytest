<div class="rightbar">
                ...
                <div class="infobar">
                    ...
                    <ul class="list-inline mb-0">
                        ...
                        <li class="list-inline-item">
                            <div class="btn-group">
                              <button class="btn btn-sm dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Language <i class="feather icon-chevron-down"></i>
                              </button>
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="languagelink">
                                    <a class="dropdown-item" href="#"><i class="flag flag-icon-us flag-icon-squared mr-1"></i>English</a>
                                    <a class="dropdown-item" href="#"><i class="flag flag-icon-de flag-icon-squared mr-1"></i>German</a>
                                    <a class="dropdown-item" href="#"><i class="flag flag-icon-bl flag-icon-squared mr-1"></i>France</a>
                                    <a class="dropdown-item" href="#"><i class="flag flag-icon-ru flag-icon-squared mr-1"></i>Russian</a>                                                
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="list-inline-item">
                            <div class="btn-group">
                              <button class="btn btn-sm dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Reports <i class="feather icon-chevron-down"></i>
                              </button>
                        ...
                        <li class="list-inline-item mr-5">
                            <div class="btn-group">
                              <button class="btn btn-sm dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Projects <i class="feather icon-chevron-down"></i>
                              </button>
                              <div class="dropdown-menu">
                                    <a class="dropdown-item" href="#">Action</a>
                                    <a class="dropdown-item" href="#">Another action</a>
                        ...
                        <li class="list-inline-item">
                            <div class="notifybar">
                                <div class="dropdown">
                                    <a class="dropdown-toggle infobar-icon text-center" href="#" role="button" id="notoficationlink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <!-- <img src="assets/images/svg-icon/mail.svg" class="img-fluid" alt="notifications"> -->
                                        <i class="feather icon-mail m-0 p-0" style="font-size: 20px; color: #666666;"></i>
                                    <span class="live-icon my-0 py-0"></span></a>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profilelink">
                                        ...
                                        <div class="userbox">
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                <li class="media dropdown-item">
                                                    <a href="{{ route('logout') }}" class="profile-icon" onclick="event.preventDefault(); document.getElementById('logout').submit();"><img src="assets/images/svg-icon/logout.svg" class="img-fluid" alt="logout">Logout</a>
    ...
    <div class="footerbar">
        <footer class="footer">
            <p class="mb-0 pull-left">© {{ date("Y") }} Tester - All Rights Reserved.</p>
        </footer>
    </div>
    <!-- End Footerbar -->
</div>